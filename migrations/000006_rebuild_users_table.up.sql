-- Repair leftover users schema that predates 000002.
-- 000002 used CREATE TABLE IF NOT EXISTS, so golang-migrate marked it applied
-- without replacing the old table (no email, VARCHAR application_id, etc.).
